...
## 내용 작성 원칙
- 사진 속 손글씨를 읽고, 우리 친구 글에서 구체적으로 잘한 점만 칭찬합니다.
...
def get_feedback_user_prompt(
    ...
    prompt_parts = [
        ...
        f"학습 단계: {level_label}",
        f"다음 글쓰기 미션 ({stage_num}단계): {stage_title}",
        f"미션 설명: {stage_description}",
        f"미션에서 기대하는 표현: {stage_mission}",
        "",
        "첨부 사진은 우리 친구가 이번에 손으로 쓴 글쓰기 워크시트입니다.",
        "사진에서 잘한 점을 칭찬한 뒤, 피드백 마지막에 위 다음 글쓰기 미션을 안내하세요.",
